...
// Mantener fecha y hora de las compras en instalaciones ya existentes.
if ($mysqli->query("ALTER TABLE mercado_compras MODIFY fecha_compra DATETIME NOT NULL")) {
    $resultados[] = ['exito' => true, 'mensaje' => 'Marca de tiempo de compras actualizada correctamente.'];
} else {
    $resultados[] = ['exito' => false, 'mensaje' => 'Error al actualizar la marca de tiempo de compras: ' . $mysqli->error];
}
...
// ============================================================
// PASO 6: Crear tabla de log (auditoria de cantidades)
// ============================================================
$sql_log = "CREATE TABLE IF NOT EXISTS log_mercado (
    id INT AUTO_INCREMENT PRIMARY KEY,
    id_producto INT NOT NULL,
    nombre_producto VARCHAR(200) NOT NULL,
...
if ($mysqli->query($sql_log)) {
    $resultados[] = ['exito' => true, 'mensaje' => 'Tabla <strong>log_mercado</strong> creada correctamente.'];
} else {
    $resultados[] = ['exito' => false, 'mensaje' => 'Error al crear tabla log_mercado: ' . $mysqli->error];
}

// ============================================================
// PASO 7: Insertar categorías predeterminadas
// ============================================================
