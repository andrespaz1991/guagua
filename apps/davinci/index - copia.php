    ...
    <div class="app-shell">
        ...
        <main class="workspace">
            ...
            <section class="drawing-toolbar" aria-label="Herramientas de dibujo">
                ...
                <button id="fit100Button" class="tool-button" type="button" aria-pressed="false" title="Ajustar lienzo al 100% de la pantalla"><i class="fa-solid fa-expand" aria-hidden="true"></i><span>100% Pantalla</span></button>
