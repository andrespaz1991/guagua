    ...
    <aside id="sidebar" class="w-[45%] min-w-[380px] max-w-[60%] bg-white border-r border-slate-200 flex flex-col h-full relative shadow-sm z-10">
        <div class="p-6 overflow-y-auto flex-1">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1">
                        <label class="block text-sm font-medium text-slate-700">Tú asignas: Observaciones Adicionales</label>
                ...
                <button id="btnDescargarWordSidebar" class="w-full mt-4 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-md transition-colors shadow-sm flex justify-center items-center gap-2">
