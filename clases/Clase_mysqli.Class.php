...
class Clase_mysqli extends Comun {
    ...
    private $clavebd;
    private $basededatos;
    private $con; // Changed from private $cona;

    // Use a static property to hold the single connection instance
    private static $connectionInstance;

    function __construct() {
        // We will now handle connection in the conectar method
    }
    ...
    public function desconectar() {
        // With a single, persistent connection, we don't need to close it
        // after every operation. The connection will close automatically when the
        // script finishes. You can remove this method call from other functions.
    }
