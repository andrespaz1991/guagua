...
$sql = 'Select identificacion , nombre,apellido from docente where identificacion = "'.$user.'" and clave = "'.$pass.'" union select id_estudiante as identificacion ,nombre,apellido from estudiante where usuario = "'.$user.'" and clave = "'.$pass.'"  ';require("conexion.php");
...
//sesion start
    ...
    $_SESSION['id_usu']  = $row['identificacion'];
...
$sql = 'Select identificacion , nombre, apellido from docente where identificacion = "'.$user.'" and clave = "'.$pass.'" union select id_estudiante as identificacion ,nombre, apellido from estudiante where usuario = "'.$user.'" and clave = "'.$pass.'"  ';
require("conexion.php");
$consulta =$mysqli -> query ($sql);
if ($row =  $consulta -> fetch_assoc())
{
...
//    $_SESSION['tipo']  = 'estudiante';
	#header('location:../modulo/seleccionar_listas.php');
	header('location:../php/resultados.php');
}
else{
    header('location:../index.php');
}
...
$concatenavalue="";
 ...
 print    $sql ='INSERT INTO estudiante ('.$dec.') VALUES ( '.$valores.')' ;
   ...
   header('location:../modulo/ingresar_estudiante.php');
                          }
                                }
}         
}
